          ...
          <form className="w-100 mx-auto ">
            ...
            <div className="d-flex justify-content-center align-items-center flex-wrap">
              <button
                ...
                className="btn orange_color_bg text-white w-75 hover-effect"
              >
                {" "}
                Continue
              </button>
              <GoogleButton
                className="w-75 mt-2 hover-effect google-btn hover-effect"
              ...
              <button
                ...
                id="facebook-login"
                name="facebook-login"
                className="btn btn-primary w-75  mt-2 fb-login-button hover-effect "
              ...
              <p className="mt-3 ms-3 w-100 text-center">
